...
const commandCollection = new Map<string, CommandBody>();
...
const getCommand = (commandName: string) => commandCollection.get(commandName);
...
const registerCommands = async (
  ...
  for (const { data, execute } of commands) {
    commandCollection.set(data.name, { execute });
...
export { CommandInteraction, buildCommand, getCommand, registerCommands };
